...
def main_menu():
    ...
    print (" $$  $$<    $$$$$$$ |  \033[1;36mKali linux tools installer\033[1;m |$$ |$$ |$$ |  $$ |")
    print (" \033[1;36m$$ |\$$\  $$  __$$ |  $$ |$$\ $$ |  $$ |$$ |  $$ |$$ |$$ |$$ |  $$ |")
    print (" $$ | \$$\ \$$$$$$$ |  \$$$$  |\$$$$$$  |\$$$$$$  |$$ |$$ |$$ |  $$ |")
    print (" \__|  \__| \_______|   \____/  \______/  \______/ \__|\__|\__|  \__| V3.0 \033[1;m")
    print ("")
    print ("")
    print (" \033[1;32m+ -- -- +=[ Original Script by: LionSec | Homepage: www.neodrix.com \033[1;m")
    print (" \033[1;32m+ -- -- +=[ Rewrited by: Nysioko\033[1;m")
    print (" \033[1;32m+ -- -- +=[ Latest update: 17/05/2022\033[1;m")
    print (" \033[1;32m+ -- -- +=[ 331 Tools \033[1;m")
    print ("")
    print ("")
    print ("\033[1;91m[W] Before updating and upgrading your system, please remove all Kali-linux repositories to avoid any kind of problem.\033[1;m")
    print ("\033[1;91m[W] In somes cases, Kali-linux repositories can destabilize your system or worse, completely destroy it.\033[1;m")
    print ("")
    ...
    try:
        ...
        def inicio1():
            while True:
                ...
                if opcion0 == "exit" or opcion0 == "quit":
...
0) Install all Information Gathering tools
						...
						''')
                            ...
                            if opcion2 == "1":
                                ...
                                inicio1()
                            elif opcion2 == "exit" or opcion2 == "quit":
                                sys.exit()
                            elif opcion2 == "help":
                                print("Available commands:\n"
                                "back\t\tGo back to main menu\n"
